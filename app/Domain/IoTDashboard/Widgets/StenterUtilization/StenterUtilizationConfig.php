...
final class StenterUtilizationConfig implements WidgetConfig
{
    /**
     * @param  array{status: array{device_id: int, schema_version_topic_id: int, parameter_key: string}|null, length: array{device_id: int, schema_version_topic_id: int, parameter_key: string}|null}  $sources
    ...
    /**
     * @return array{status: array{device_id: int, schema_version_topic_id: int, parameter_key: string}|null, length: array{device_id: int, schema_version_topic_id: int, parameter_key: string}|null}
     */
    ...
    private static function normalizeSources(mixed $sources): array
    {
        ...
        return [
            'status' => self::normalizeSource($sources['status'] ?? null, 'status'),
            'length' => self::normalizeSource($sources['length'] ?? null, 'length'),
        ];
    }
