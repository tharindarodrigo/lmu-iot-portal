...
class NotificationProfile extends Model
{
    ...
    /** @return HasMany<ThresholdPolicy, $this> */
    public function thresholdPolicies(): HasMany
    {
        return $this->hasMany(ThresholdPolicy::class, 'notification_profile_id');
    }

    /** @return BelongsToMany<User, $this> */
    public function users(): BelongsToMany
    {
        return $this->belongsToMany(User::class, 'notification_profile_user', 'notification_profile_id', 'user_id')
            ->withTimestamps();
    }
