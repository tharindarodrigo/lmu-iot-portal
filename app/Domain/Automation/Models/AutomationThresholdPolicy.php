...
class AutomationThresholdPolicy extends Model
{
    ...
    /** @return BelongsTo<AutomationNotificationProfile, $this> */
    public function notificationProfile(): BelongsTo
    {
        return $this->belongsTo(AutomationNotificationProfile::class, 'notification_profile_id');
    }
